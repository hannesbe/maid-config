...
# Move .PDF files from G-Drive to Nextcloud
  rule 'Move files in G-Drive to Nextcloud' do
    ...
    move(dir('~/G-Drive/_IN/Finmo/F&A/*'), '~/Nextcloud/_Connexeon/F&A/_IN')
    move(dir('~/G-Drive/_IN/Kay/F&A/*'), '~/Nextcloud/_Connexeon/F&A/_IN')
    move(dir('~/G-Drive/_IN/Nexus/F&A/*'), '~/Nextcloud/_Connexeon/F&A/_IN')
